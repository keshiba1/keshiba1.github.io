...
generated:
  ...
  generated_at: '2026-05-09T17:31:34Z'
draft: false
---
...
1. **Scraping plates and dropping them in the sink with water.** Everyone in the house — my husband, my daughter, and I — clears their own *jootha* off the plate and puts the dish in the sink with a little water on it.
2. **Unloading the dishwasher only when I'm about to reload it.** I don't unload as a separate task. Clean *bartan* stay inside the dishwasher until I need them, or until I'm loading the next round.
3. **Loading dirty dishes into the dishwasher.** A quick rinse to clear food bits, then straight into the rack.
4. **Refilling any jar from a packet I opened that day.** Tonight it was *ajwain* — straight into a glass bottle.
5. **Soaking almonds for tomorrow morning.** A small bowl of *badam* in water, covered, on the counter.
6. **Putting up the mosquito net before bed.**
...
> 📺 **About this video.** This post draws on Jasmine Choudhari's YouTube video [किचन के क्या क्या काम करने पड़ें रात में My Evening Routine & Habits](https://www.youtube.com/watch?v=5izsefGxjHE). Watch the full video for visual demonstrations of every tip.
